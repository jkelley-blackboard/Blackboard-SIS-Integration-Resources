...
For best practices on recording the reference code and using `dataSetStatus` as part of your own integration — not just a one-off manual check — see [Working with the Reference Code and Status Endpoint](reference-code-best-practices.md).
